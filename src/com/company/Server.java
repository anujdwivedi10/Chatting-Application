...
public class Server implements ActionListener
{
    ...
    Server()
    {
        ...
        textArea = new JPanel();           // here all messages will be displayed
...
//        textArea.setBackground(Color.lightGray);
        ...
        sp.setBorder(BorderFactory.createEmptyBorder());     // empty border because scrollpane gives default border
    ...
    public void actionPerformed(ActionEvent ae)
    {
        try
        {
            ...
            textArea.add(vertical,BorderLayout.PAGE_START);       // latest message will be shown at the bottom
    ...
    public static void sendTextToFile(String message) throws FileNotFoundException
    {
        ...
        {
            pw.println("Lionel Messi: " + message);      // now printing messages in the file
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public static  JPanel formatLabel(String out)
    {
        ...
        JLabel label = new JLabel("<html><p style= \"width : 150px\">"+ out +"</p></html>");      // using this so that text is displayed right below the starting point of previous line
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            while(true)
            {
                ...
                while (true)
                {
                    msginput = din.readUTF();      // taking received data
                    JPanel jp = formatLabel(msginput);    // formatting it

                    JPanel left = new JPanel(new BorderLayout());
                    left.add(jp, BorderLayout.LINE_START);         // displaying it to the left side
                    vertical.add(left);
